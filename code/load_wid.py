...
def load_rolelable():
    ...
    lm_lable_img = tk.Label(root, image=gc.get_value("lmTK"), width=50, height=50)
    lm_lable = tk.Label(root, image=gc.get_value("boardTK"), textvariable=lm_cnt, font=("Helvetica", 34, "bold"), compound=tk.CENTER, height=60)
